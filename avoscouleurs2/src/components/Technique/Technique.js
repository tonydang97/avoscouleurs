            ...
            <div className='container'>
                ...
                <Link to="/infographie"><div className='box btn_shadow'>
                   ...
                   <Link to="/serigraphie"><div className='box btn_shadow'>
                        ...
                        <h2>Sérigraphie</h2>
                       <p id="desctruncate">La sérigraphie est la technique de marquage préconisée pour les volumes importants...</p>
                        <a href="/">
                            <i className='fas fa-arrow-right'></i>
                        </a>
                    </div>
                    ...
                    <Link to="/signaletique"><div className='box btn_shadow'>
                        ...
                        <h2>Signalétique</h2>
                       <p id="desctruncate">Pour tout vos objets et panneaux publicitaires qui servent à refleter...</p>
                        <a href="/">
                            <i className='fas fa-arrow-right'></i>
                        </a>
                    </div>
